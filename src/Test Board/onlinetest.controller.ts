...
onlinetestRouter.get(
  '/getObjectiveQuestions/:subjectName_Id/:ClassName_Id/:type/:question/:Stream_Id/:studentId',
  (req,res)=>getObjectiveQuestions(req,res)
);
// With mode
onlinetestRouter.get(
  '/getObjectiveQuestions/:subjectName_Id/:ClassName_Id/:type/:question/:Stream_Id/:studentId/:mode',
  (req,res)=>getObjectiveQuestions(req,res)
);
