...
StreamRouter.get("/getStreamDetails",auth,(req,res) => getStreamDetails(req,res));
StreamRouter.post('/updateStream', auth,(req, res)=> updateStream(req, res));
StreamRouter.delete("/deleteStream/:Stream_Id",auth,(req,res) => deleteStream(req,res));
// StreamRouter.delete("/deleteStream/: Streamid" (req,res) => deleteStream(req,res));
StreamRouter.post("/updateStreamStatus",auth,(req,res) => updateStreamStatus(req,res));
